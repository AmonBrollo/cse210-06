...
class Image:
    ...
    GREEN_LASER = Assets.image.load(Path.GRAPHICS_PATH, 'pixel_laser_green.png')
    FLAME_LASER = Assets.image.load(Path.GRAPHICS_PATH, 'pixel_laser_flame.png')
    ...
    GO_BACK_IMAGE = Assets.image.scale(Path.GRAPHICS_PATH, 'back_arrow.png', 6/25)
    ...
    LEVELS_IMAGE = Assets.image.scale(Path.GRAPHICS_PATH, 'levels_button.png', 1/3)
    SCORE_IMAGE = Assets.image.scale(Path.GRAPHICS_PATH, 'score_button.png', 1/3)
    KILLS_IMAGE = Assets.image.scale(Path.GRAPHICS_PATH, 'kills_button.png', 1/3)

    MOUSE = Assets.image.scale(Path.GRAPHICS_PATH, 'mouse.png', 1/2)
    LEFT_MOUSE_CLICK = Assets.image.scale(Path.GRAPHICS_PATH, 'left_click_mouse.png', 1/2)
    RIGHT_MOUSE_CLICK = Assets.image.scale(Path.GRAPHICS_PATH, 'right_click_mouse.png', 1/2)
    ...
    BACKSPACE_KEYS = Assets.image.scale(Path.GRAPHICS_PATH, 'backspace_key.png', 1/2)
    SPACEBAR_KEY = Assets.image.scale(Path.GRAPHICS_PATH, 'spacebar_key.png', 1/2)
    ...
    class Sound:
        PLAYER_LASER_SOUND = Assets.sounds.load(Path.SOUND_PATH, 'ownlaser.wav')
        ENEMY_LASER_SOUND = Assets.sounds.load(Path.SOUND_PATH, 'enemylaser.wav')
